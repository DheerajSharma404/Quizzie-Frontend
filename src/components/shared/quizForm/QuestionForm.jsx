...
//     if (formData?.questions[index]?.correctAnswer) {
//       const correctAnswer = formData?.questions[index]?.correctAnswer;
//       setCorrectAnswer(correctAnswer);
//     }
//     if (formData?.questions[index]?.timer) {
//       const timer = formData?.questions[index]?.timer;
//       setTimer(timer);
//     }
...
//       const validation =
//         QuizValidation.quizValidationSchema.safeParse(formData);
...
//         ) {
//           return toast.error("Please select correct answer for all questions");
//         }
//       }
...
//                 onClick={() => handleCurrentQuestion(item?.id)}
//               >
//                 {index + 1}
//                 {index > 0 && (
//                   <button
